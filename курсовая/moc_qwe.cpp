/****************************************************************************
** Meta object code from reading C++ file 'qwe.h'
**
...
#include "C:/untitled2/qwe.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'qwe.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 15, 17), // "signalWithContent"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 7), // "content"
QT_MOC_LITERAL(4, 42, 13) // "replyFinished"

    },
    "NetworkManager\0signalWithContent\0\0"
    "content\0replyFinished"
};
...
void NetworkManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalWithContent((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetworkManager::signalWithContent)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void NetworkManager::signalWithContent(const QString _t1)
{
