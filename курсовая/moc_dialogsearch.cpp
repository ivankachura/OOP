...
#include "C:/untitled2/dialogsearch.h"
...
void Dialogsearch::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Dialogsearch::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Dialogsearch::firstWindow)) {
                *result = 0;
                return;
            }
        }
